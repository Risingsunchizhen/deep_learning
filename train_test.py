...
model = TwoLayerNet(input_size=784, hidden_size=hidden_size, output_size=10,weight_decay_lambda=0.03)
...
print("分类精度:",np.sum(np.argmax(y_pred,axis=1)==np.argmax(t,axis=1))/len(y_pred))